...
- **Pay-as-you-go** — no subscriptions, 100+ models behind one API key
- **Enterprise-ready** — multi-member teams, role-based permissions, per-member budgets, encrypted API key storage
...
- **零订阅** — 按量付费，100+ 模型一个 API Key 接入
- **多成员团队管理** — 角色权限分配，成员预算管理，API Key 加密存储
